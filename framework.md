...
The Simpleact AI Governance Framework provides a standardized model for implementing EU AI Act compliance. This repository defines the ai act templates layer of that model.
...
A standardized model for reusable AI compliance templates.
